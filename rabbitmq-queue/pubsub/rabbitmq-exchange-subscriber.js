...
amqp.connect(rabbitMqConnextionString, function(error0, connection) {
    ...
    connection.createChannel(function(error1, channel) {
        ...
        channel.assertExchange(exchangeToSubscribe,"fanout", {
            durable: false
        });
        ...
        channel.assertQueue('',{
            ...
            console.log(`[SUBSCRIBER] >> Subscriber listenning [${host}:${port}] on exchange: ${exchangeToSubscribe}, queue: ${q.queue}`)
            channel.bindQueue(q.queue, exchangeToSubscribe, '');
